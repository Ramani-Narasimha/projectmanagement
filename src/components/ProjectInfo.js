...
class ProjectInfo extends Component {
    ...
    submitTask(event) {
        ...
        axios.post("https://backend-project-ngen.onrender.com/tasks/create",
    ...
    completeTask(event) {
        ...
        let token = localStorage.getItem("token");
        axios.post("https://backend-project-ngen.onrender.com/tasks/" + taskId + "/complete",
            {},
            {
                headers: {
                    'Authorization': 'Bearer ' + token
    ...
    removeTask(event) {
        ...
        let token = localStorage.getItem("token");
        axios.delete("https://backend-project-ngen.onrender.com/tasks/" + taskId + "/delete",
            {
                headers: {
                    'Authorization': 'Bearer ' + token
                }
    ...
    removeProject(event) {
        ...
        let token = localStorage.getItem("token");
        axios.delete("https://backend-project-ngen.onrender.com/projects/" + projectId + "/delete",
            {
                headers: {
                    'Authorization': 'Bearer ' + token
                }
